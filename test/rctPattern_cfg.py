...
process.htr_xml = cms.EDFilter("HtrXmlPattern",
    ...
    file_tag = cms.untracked.string('walkingOnes'),
...
process.L1RCTPatternTestAnalyzer.showRegionSums = True #True
process.L1RCTPatternTestAnalyzer.testName = 'walkingOnes'
...
process.rctPattern = cms.EDProducer("L1RCTPatternProducer",
    ...
    testName = cms.untracked.string('walkingOnes'),
...
process.ecalSimRawData.outputBaseName = 'data/walkingOnes/ecal'
